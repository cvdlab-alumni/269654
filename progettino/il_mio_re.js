...
var get_parametric_curve = function (x,z,alpha){
	// x = valore della variazione da quello di partenza
...
var domain = PROD1x1([INTERVALS(1)(40),INTERVALS(1)(30)]);
...
//secondoooooooooooooooooooooooooooo corpo
...
var get_croce = function (){
	...
	var get_verticale = function(){
		...
		//base
					...
					var curve1 = COLOR([1,1,0.82])(MAP(curveMapping1)(domain));
					//DRAW(curve);

					//parte piccola
					var controlpoints = [[1.2,1,0],[1.4,1,0],[0,0,0],[0,0,0]];
					var curveMapping2 = CUBIC_HERMITE(S0)(controlpoints);
					var curve2 = COLOR([1,1,0.82])(MAP(curveMapping2)(domain));
					//DRAW(curve);
					...
					var curve3 = COLOR([1,1,0.82])(MAP(curveMappingD)(domain));
					//DRAW(curve);

					//diagonale sinistra
					var controlpoints = [[1,0,0],[1.2,1,0],[0.5,0,0],[-0.5,0,0]];
					var curveMappingS = CUBIC_HERMITE(S0)(controlpoints);
					var curve4 = COLOR([1,1,0.82])(MAP(curveMappingS)(domain));
					//DRAW(curve);
					...
					var curve5 = COLOR([1,1,0.82])(MAP(curveMapping3)(domain));
					//DRAW(curve);

					//parte piccola
					var controlpoints = [[1.2,1,0.2],[1.4,1,0.2],[0,0,0],[0,0,0]];
					var curveMapping4 = CUBIC_HERMITE(S0)(controlpoints);
					var curve6 = COLOR([1,1,0.82])(MAP(curveMapping4)(domain));
					//DRAW(curve);
					...
					var curve7 = COLOR([1,1,0.82])(MAP(curveMappingD1)(domain));
					//DRAW(curve);

					//diagonale sinistra
					var controlpoints = [[1,0,0.2],[1.2,1,0.2],[0.5,0,0],[-0.5,0,0]];
					var curveMappingS1 = CUBIC_HERMITE(S0)(controlpoints);
					var curve8 = COLOR([1,1,0.82])(MAP(curveMappingS1)(domain));
					//DRAW(curve);
	...
	var get_orizzontale = function (){
		...
		var get_orizzontal_cruise = function(){
			...
			var curveMappingS = CUBIC_HERMITE(S0)(controlpoints);
			var curve3 = COLOR([1,1,0.82])(MAP(curveMappingS)(domain));
			//DRAW(curve1);

			var controlpoints = [[1.4,0.3,0],[1.6,0,0],[-0.5,0,0],[0.5,0,0]];
			var curveMappingD = CUBIC_HERMITE(S0)(controlpoints);
			var curve4 = COLOR([1,1,0.82])(MAP(curveMappingD)(domain));
			//DRAW(curve1);
			...
			var curveMappingS1 = CUBIC_HERMITE(S0)(controlpoints);
			var curve7 = COLOR([1,1,0.82])(MAP(curveMappingS1)(domain));
			//DRAW(curve1);

			var controlpoints = [[1.4,0.3,0.2],[1.6,0,0.2],[-0.5,0,0],[0.5,0,0]];
			var curveMappingD1 = CUBIC_HERMITE(S0)(controlpoints);
			var curve8 = COLOR([1,1,0.82])(MAP(curveMappingD1)(domain));
			//DRAW(curve1);
