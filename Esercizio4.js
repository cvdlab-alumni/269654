...
COLOR([0.76,0.29,0.13])(portantRightBuildingWall1);
...
var piediTavolo = SIMPLEX_GRID([[0.5,-2,0.5],[0.7],[0.5]]);
var baseTavolo = T([0,2])([-0.25,0.5])(SIMPLEX_GRID([[3.5],[1.2],[0.2]]));

var tavolo = STRUCT([piediTavolo,baseTavolo]);

var piediTavolo1 = SIMPLEX_GRID([[0.7],[0.5,-2,0.5],[0.5]]);
var baseTavolo1 = T([0,2])([-0.25,0.5])(SIMPLEX_GRID([[1.2],[3.5],[0.2]]));

var tavolo1 = STRUCT([piediTavolo1,baseTavolo1]);


COLOR([0.96,0.8,0.69])(baseStucture);
COLOR([1,0,0])(tavolo);
COLOR([1,0,0])(tavolo1);
COLOR([1,1,1])(rightRoof);
COLOR([1,1,1])(leftroof);

var pavilion = STRUCT([baseStucture,murature, T([0,1,2])([2,12,1]),tavolo,T([0,1])([21,-10]),tavolo1]); 
